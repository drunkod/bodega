  ...
  <header>
    <nav class="flex items-center justify-between flex-wrap bg-gray-900 p-6">
      ...
      >
        ...
        <span
          class="font-light text-xl tracking-tight pl-3 border-l border-white"
        >
          Bodega
        </span>
      </router-link>
      <div class="flex items-center flex-shrink-0 text-white ml-6">
        <button
          ...
          class="
            ...
            text-white
            border-white
            hover:border-transparent hover:text-gray-900 hover:bg-white
            mt-4
            lg:mt-0
          "
        >
        ...
        <div v-else>
          ...
          <div class="inline-block text-sm leading-none text-white ml-4">
